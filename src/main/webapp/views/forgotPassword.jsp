...
<style>
    ...
    .login-text { text-align: center; margin-top: 30px; font-size: 0.95em; color: #6c757d; }
    .login-text a { color: #28a745; text-decoration: none; font-weight: 600; }
...
<body>
	<div class="login-container">
		<form action="forgot-password" method="post"> 
			...
			<p class="text-center text-muted">Please enter email address to reset password.</p>
